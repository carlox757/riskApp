...
public class cardGameScreen7 extends AppCompatActivity {
            ...
            switch (view.getId())
            {
                case R.id.option1:
                    if(checked1){
                        ...
                        Intent option1Intent = new Intent(cardGameScreen7.this, ratingBar6.class);
                        current_user.child("Card Seventh Choice").setValue("Option 1");
                ...
                case R.id.decoyOptionDecoy:
                    if(checked3){
                        ...
                        win1 = 0;
                        play.setVisibility(View.VISIBLE);
                        Intent decoyIntent = new Intent(cardGameScreen7.this, ratingBar6.class);
                        current_user.child("Card Seventh Choice").setValue("Decoy Option");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardgamescreen7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goHome = new Intent(cardGameScreen7.this, ratingBar6.class );
