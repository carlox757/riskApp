...
public class cardGameScreen4 extends AppCompatActivity {
                    ...
                    if(checked1){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent option1Intent = new Intent(cardGameScreen4.this, ratingBar3Option1.class);
                                current_user.child("Card Fourth Choice").setValue("Option 1");
                ...
                case R.id.decoyOptionDecoy:
                    if(checked3){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent decoyIntent = new Intent(cardGameScreen4.this, ratingBar3Option2.class);
                                current_user.child("Card Fourth Choice").setValue("Decoy Option");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardgamescreen4);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goHome = new Intent(cardGameScreen4.this, ratingBar3Option1.class );
