...
public class cardGameScreen3 extends AppCompatActivity {
                    ...
                    if(checked1){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent option1Intent = new Intent(cardGameScreen3.this, ratingBar2.class);
                                current_user.child("Card Third Choice").setValue("Option 1");
                ...
                case R.id.option2:
                    if(checked2){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent option2Intent = new Intent(cardGameScreen3.this, ratingBar2.class);
                                current_user.child("Card Third Choice").setValue("Option 2");
                ...
                case R.id.decoyOptionDecoy:
                    if(checked3){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent decoyOptionIntent = new Intent(cardGameScreen3.this, ratingBar2.class);
                                current_user.child("Card Third Choice").setValue("Decoy Option");
                                startActivity(decoyOptionIntent);
                            }
                        });
                    }
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardgamescreen3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goHome = new Intent(cardGameScreen3.this, ratingBar2.class );
