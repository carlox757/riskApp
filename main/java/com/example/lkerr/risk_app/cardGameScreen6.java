...
public class cardGameScreen6 extends AppCompatActivity {
            ...
            switch (view.getId())
            {
                    ...
                    if(checked1){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent option1Intent = new Intent(cardGameScreen6.this, ratingBar5.class);
                                current_user.child("Card Sixth Choice").setValue("Option 1");
                ...
                case R.id.option2:
                    if(checked2){
                        ...
                        win3 = 0;
                        play.setVisibility(View.VISIBLE);
                        Intent option2Intent = new Intent(cardGameScreen6.this, ratingBar5.class);
                        current_user.child("Card Sixth Choice").setValue("Option 2");
                ...
                case R.id.decoyOptionDecoy:
                    if(checked3){
                        ...
                        win1 = 0;
                        play.setVisibility(View.VISIBLE);
                        Intent decoyIntent = new Intent(cardGameScreen6.this, ratingBar5.class);
                        current_user.child("Card Sixth Choice").setValue("Decoy Option");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardgamescreen6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goHome = new Intent(cardGameScreen6.this, ratingBar5.class );
