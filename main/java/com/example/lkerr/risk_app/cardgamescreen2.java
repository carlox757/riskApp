...
import static com.example.lkerr.risk_app.R.id.option1;

public class cardgamescreen2 extends AppCompatActivity {
    ...
    public void selectOptionDecoy(View view){
        b1 = (RadioButton) findViewById(option1);
        b2 = (RadioButton) findViewById(R.id.option2);
        b3 = (RadioButton) findViewById(R.id.decoyOptionDecoy);
                    ...
                    if(checked1){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent option1Intent = new Intent(cardgamescreen2.this, ratingBar1.class);
                                current_user.child("Card Second Choice").setValue("Option 1");
                ...
                case R.id.option2:
                    if(checked2){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent option2Intent = new Intent(cardgamescreen2.this, ratingBar1.class);
                                current_user.child("Card Second Choice").setValue("Option 2");
                ...
                case R.id.decoyOptionDecoy:
                    if(checked3){
                        ...
                        play.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent option3Intent = new Intent(cardgamescreen2.this, ratingBar1.class);
                                current_user.child("Card Second Choice").setValue("Decoy option");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardgamescreen);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //card1
                if (cards.get(0) == 1 && (win1 == 1 || win2 == 1 || win3 ==1)) {
                ...
                if (cards.get(1) == 1 && (win1 == 1 || win2 == 1 || win3 ==1)) {
                ...
                if (cards.get(2) == 1 && (win1 == 1 || win3 ==1 || win2 == 0)) {
                    card3.setImageResource(R.drawable.ace);
                    if(win1 == 1 && win2 == 0 && win3 == 0) {
                        current_user.child("gold").setValue(currentGoldValue+10);
                    }
                    else if(win1 == 0 && win3 == 1 && win2 == 0){
                        current_user.child("gold").setValue(currentGoldValue+20);
                    }
       ...
       /* next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goHome = new Intent(cardgamescreen2.this, ratingBar1.class );
